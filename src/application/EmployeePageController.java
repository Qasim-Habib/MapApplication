...
public class EmployeePageController {
	...
	void initialize() throws IOException, Exception {
		 ...
		 * 
		 * @SuppressWarnings("resource") Object data; String[] array = new String[2];
		 * array[0]="getMessages"; array[1]=Globals.user.getUserName();
		 * 
		 * Socket socket = new Socket(Globals.IpAddress,5555); ObjectOutputStream out =
		 * new ObjectOutputStream(socket.getOutputStream()); out.writeObject(array);
		 * 
		 * objectInput = new ObjectInputStream(socket.getInputStream());
		 * data=objectInput.readObject(); System.out.println(data);
		 */
